...
use theme_apguidance\form\testimonial_form;
...
$url = new moodle_url('/theme/apguidance/page/testimonial/edit.php');
$redirect_url = new moodle_url('/theme/apguidance/page/testimonial/list.php');
if ($action == 'add') {
...
$PAGE->set_pagetype('admin-apguidance-testimonial-edit');
